...
async function GET() {
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$env$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"].API_LOGGING_ENABLED) {
        const count = Array.isArray(data) ? data.length : typeof data === 'object' && data !== null && 'data' in data && Array.isArray(data.data) ? data.data.length : 0;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a077480b._.js.map